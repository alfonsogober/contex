 ...
 */
export const startStdioServer = (config: StdioConfig): (() => void) => {
 ...
 */
export const createMessageSender = (): ((method: string, params?: unknown) => void) => {
...
export const sendLogMessage = (
  sender: (method: string, params?: unknown) => void,
