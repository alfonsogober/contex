 ...
 */
export declare const map: <T, U, E>(fn: (t: T) => U) => (result: Result<T, E>) => Result<U, E>;
/**
 ...
 * @returns A function that takes a Result and returns a new Result
 */
export declare const flatMap: <T, U, E>(fn: (t: T) => Result<U, E>) => (result: Result<T, E>) => Result<U, E>;
/**
 ...
 * @returns A function that takes a Result and returns a new Result
 */
export declare const mapErr: <T, E, F>(fn: (e: E) => F) => (result: Result<T, E>) => Result<T, F>;
/**
 ...
 */
export declare const getOrElse: <T, E>(defaultValue: T) => (result: Result<T, E>) => T;
/**
 * Extracts the value from a Result, or computes a default from the error.
 * @param fn - Function to compute default from error
 * @returns A function that takes a Result and returns the value
 */
export declare const getOrElseW: <T, E, U>(fn: (e: E) => U) => (result: Result<T, E>) => T | U;
/**
 ...
 */
export declare const fold: <T, E, U>(onErr: (e: E) => U, onOk: (t: T) => U) => (result: Result<T, E>) => U;
/**
 ...
 */
export declare const tryCatch: <T, E>(fn: () => T, onError: (e: unknown) => E) => Result<T, E>;
/**
 ...
 */
export declare const tryCatchAsync: <T, E>(fn: () => Promise<T>, onError: (e: unknown) => E) => Promise<Result<T, E>>;
/**
 ...
 */
export declare const traverse: <T, U, E>(fn: (t: T) => Result<U, E>) => (items: T[]) => Result<U[], E>;
/**
 * Converts a nullable value to a Result.
 * @param error - Error to use if value is null/undefined
 * @returns A function that takes a nullable and returns a Result
 */
export declare const fromNullable: <E>(error: E) => <T>(value: T | null | undefined) => Result<T, E>;
