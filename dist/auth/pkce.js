 ...
 */
export const computeCodeChallenge = (verifier) => {
 ...
 */
export const generatePkceParams = () => {
 ...
 */
export const validateCodeVerifier = (verifier, challenge) => computeCodeChallenge(verifier) === challenge;
/**
 ...
 */
export const isValidCodeChallenge = (challenge) => {
 ...
 */
export const pkceToQueryParams = (params) => ({
 ...
 */
export const pkceToTokenParams = (verifier) => ({
 ...
 */
export const generateNonce = () => base64UrlEncode(randomBytes(32));
